...
class TestClient(Node):
    ...
    def timer_callback(self):
        ...
        exclude_poly_list = [
            # Triangle
            [(100, 100), (150, 50), (200, 100), (100, 100)],  # Triangle exclusion zone

            # Pentagon
            [(300, 300), (350, 250), (400, 300), (375, 350), (325, 350), (300, 300)],  # Pentagon exclusion zone

            # Irregular Quadrilateral
            [(600, 200),  (700, 200), (675, 150), (600, 200)],  # Irregular quadrilateral exclusion zone

            # Hexagon
    [(800, 400), (850, 450), (850, 500), (800, 550), (750, 500), (750, 450), (800, 400)],  # Hexagon exclusion zone
            # Irregular Shape
            [(200, 700), (250, 750), (300, 720), (280, 680), (220, 680), (200, 700)]   # Irregular shape exclusion zone
        ]
        # exclude_poly_list = []
